class ActivitiesPolicyMarkerController < ApplicationController
  # GET /policy_markers_activities
  # GET /policy_markers_activities.xml
  def index
    @policy_markers_activities = ActivitiesPolicyMarker.all
  ...
  def show
    @policy_markers_activity = ActivitiesPolicyMarker.find(params[:id])
  ...
  def new
    @policy_markers_activity = ActivitiesPolicyMarker.new
  ...
  def create
    @policy_markers_activity = ActivitiesPolicyMarker.new(params[:policy_markers_activity])

    respond_to do |format|
      if @policy_markers_activity.save
        format.html { redirect_to(@policy_markers_activity, :notice => 'ActivitiesPolicyMarker was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @policy_markers_activity.update_attributes(params[:policy_markers_activity])
        format.html { redirect_to(@policy_markers_activity, :notice => 'ActivitiesPolicyMarker was successfully updated.') }
        format.xml  { head :ok }
      else
