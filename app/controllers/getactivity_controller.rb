...
#		end
	...
	def exportactivities 
		...
		#header row
		csv << ["t_id", "t_value", "t_value_date", "t_value_currency", "t_transaction_type", "t_transaction_type_code", "t_provider_org", "t_provider_org_ref", "t_provider_org_type", "t_receiver_org", "t_receiver_org_ref", "t_receiver_org_type", "t_description", "t_transaction_date", "t_transaction_date_iso", "t_disbursement_channel_code", "a_id", "a_package_id",	"a_activity_lang",  "a_hierarchy", "a_last_updated", "a_reporting_org",  "a_reporting_org_ref", 	"a_reporting_org_type", "a_funding_org", "a_funding_org_ref", "a_funding_org_type", "a_extending_org", "a_extending_org_ref",  "a_extending_org_type", "a_implementing_org", "a_implementing_org_ref", "a_implementing_org_type", "a_recipient_region", "a_recipient_region_code", "a_recipient_country", "a_recipient_country_code", "a_collaboration_type", "a_collaboration_type_code", "flow_type", "flow_type_code", "aid_type", "aid_type_code", "finance_type", "finance_type_code", "a_iati_identifier", "a_title", "description", "a_date_start_actual", "a_date_start_planned", "a_date_end_actual", "a_date_end_planned", "a_status_code", "a_status", "a_contact_organisation", "a_contact_telephone", "a_contact_email", "a_contact_mailing_address", "a_default_tied_status", "a_default_tied_status_code", "a_legacy_data_name", "a_legacy_data_value", "a_legacy_data_iati_equivalent", "a_activity_website", "a_countryregion_id",  "r_id",  "r_iati_identifier", "r_title"]
	  @messages = ''
	  @transactions = Transaction.find(:all, :limit=>300)
	  @transactions.each do |transaction|
	    @activity = Activity.find(transaction.activity_id)
